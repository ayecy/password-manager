...
const getPasswords = async (masterKey) => {
  const response = await axios.get(`${API_BASE}/passwords`, {
    headers: { "X-Master-Key": masterKey }
  });
  return response.data;
};
const addPassword = async (entry, masterKey) => {
  await axios.post(`${API_BASE}/passwords`, entry, {
    headers: { "X-Master-Key": masterKey }
  });
};
const updatePassword = async (service, entry, masterKey) => {
  await axios.put(`${API_BASE}/passwords/${service}`, entry, {
    headers: { "X-Master-Key": masterKey }
  });
};
const deletePassword = async (service, masterKey) => {
...
const _hoisted_1$3 = { class: "modal" };
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        createBaseVNode("div", _hoisted_2$3, [
          _cache[3] || (_cache[3] = createBaseVNode("div", { class: "modal-header" }, [
            createBaseVNode("svg", {
              width: "24",
              height: "24",
              viewBox: "0 0 24 24",
              ...
              createBaseVNode("path", {
                d: "M19 11H5C3.89543 11 3 11.8954 3 13V21C3 22.1046 3.89543 23 5 23H19C20.1046 23 21 22.1046 21 21V13C21 11.8954 20.1046 11 19 11Z",
                stroke: "currentColor",
                "stroke-width": "2",
            ...
            createBaseVNode("h2", null, "Введите мастер-ключ")
          ], -1)),
          ...
          createBaseVNode("form", {
            ...
            withDirectives(createBaseVNode("input", {
              type: "password",
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => masterKey.value = $event),
              placeholder: "Мастер-ключ",
              autofocus: "",
              required: ""
            }, null, 512), [
              [vModelText, masterKey.value]
            ]),
            _cache[2] || (_cache[2] = createBaseVNode("button", { type: "submit" }, "Разблокировать", -1))
          ], 32)
        ])
      ]);
    };
...
const _hoisted_2$2 = { "data-label": "Сервис" };
const _hoisted_3$2 = { "data-label": "Логин" };
const _hoisted_4$2 = { class: "copy-cell" };
const _hoisted_5$1 = { class: "login-text" };
...
const _hoisted_9 = { "data-label": "Пароль" };
const _hoisted_10 = { class: "copy-cell" };
        ...
        createBaseVNode("table", null, [
          _cache[5] || (_cache[5] = createBaseVNode("thead", null, [
            createBaseVNode("tr", null, [
              createBaseVNode("th", null, "Сервис"),
              createBaseVNode("th", null, "Логин"),
              createBaseVNode("th", null, "Пароль"),
              createBaseVNode("th", null, "Действия")
            ])
          ], -1)),
          createBaseVNode("tbody", null, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.passwords, (entry, index) => {
              return openBlock(), createElementBlock("tr", { key: index }, [
                createBaseVNode("td", _hoisted_2$2, toDisplayString(entry.service), 1),
                createBaseVNode("td", _hoisted_3$2, [
                  createBaseVNode("div", _hoisted_4$2, [
                    createBaseVNode("span", _hoisted_5$1, toDisplayString(entry.login), 1),
                    createBaseVNode("button", {
                      onClick: ($event) => handleCopyLogin(entry),
                      title: "Копировать логин"
                    }, [
                      copied.value === `login-${entry.service}` ? (openBlock(), createElementBlock("svg", _hoisted_7$1, [..._cache[0] || (_cache[0] = [
                ...
                createBaseVNode("td", _hoisted_9, [
                  createBaseVNode("div", _hoisted_10, [
                    _cache[4] || (_cache[4] = createBaseVNode("span", { class: "password-mask" }, "••••••••", -1)),
                    createBaseVNode("button", {
                      onClick: ($event) => handleCopyPassword(entry),
                      title: "Копировать пароль"
                    }, [
                      copied.value === `password-${entry.service}` ? (openBlock(), createElementBlock("svg", _hoisted_12, [..._cache[2] || (_cache[2] = [
                        createBaseVNode("polyline", {
                          points: "20 6 9 17 4 12",
                          stroke: "green",
                          "stroke-width": "2",
                      ...
                      ])])) : (openBlock(), createElementBlock("svg", _hoisted_13, [..._cache[3] || (_cache[3] = [
                        createBaseVNode("rect", {
                          x: "9",
                          y: "9",
                          width: "13",
                ...
                createBaseVNode("td", _hoisted_14, [
                  createBaseVNode("div", _hoisted_15, [
                    createBaseVNode("button", {
                      class: "edit-btn",
                      onClick: ($event) => _ctx.$emit("edit", entry),
                      title: "Редактировать"
                    }, null, 8, _hoisted_16),
                    createBaseVNode("button", {
                      class: "delete-btn",
                      onClick: ($event) => _ctx.$emit("delete", entry.service),
                      title: "Удалить"
                    }, null, 8, _hoisted_17)
                  ])
                ])
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$1, [
        createBaseVNode("h2", null, toDisplayString(__props.initialData ? "Редактировать запись" : "Добавить новую запись"), 1),
        createBaseVNode("form", {
          onSubmit: withModifiers(handleSubmit, ["prevent"])
        }, [
          createBaseVNode("div", _hoisted_2$1, [
            _cache[4] || (_cache[4] = createBaseVNode("label", null, "Сервис", -1)),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => formData.value.service = $event),
              type: "text",
              required: "",
              placeholder: "gmail.com, github.com и т.д."
            }, null, 512), [
              [vModelText, formData.value.service]
            ])
          ]),
          createBaseVNode("div", _hoisted_3$1, [
            _cache[5] || (_cache[5] = createBaseVNode("label", null, "Логин / Email", -1)),
            withDirectives(createBaseVNode("input", {
              "onUpdate:modelValue": _cache[1] || (_cache[1] = ($event) => formData.value.login = $event),
              type: "text",
              required: ""
            }, null, 512), [
              [vModelText, formData.value.login]
            ])
          ]),
          createBaseVNode("div", _hoisted_4$1, [
            createBaseVNode("label", null, [
              _cache[6] || (_cache[6] = createTextVNode(" Пароль ", -1)),
              createBaseVNode("button", {
                type: "button",
                class: "toggle-password",
                onClick: _cache[2] || (_cache[2] = ($event) => showPassword.value = !showPassword.value)
              }, toDisplayString(showPassword.value ? "Скрыть" : "Показать"), 1)
            ]),
            withDirectives(createBaseVNode("input", {
              ...
              [vModelDynamic, formData.value.password]
            ])
          ]),
          createBaseVNode("div", _hoisted_6, [
            createBaseVNode("button", _hoisted_7, toDisplayString(__props.initialData ? "Сохранить изменения" : "Добавить запись"), 1),
            __props.initialData ? (openBlock(), createElementBlock("button", {
              key: 0,
              type: "button",
              class: "cancel-btn",
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        createBaseVNode("header", null, [
          _cache[2] || (_cache[2] = createBaseVNode("h1", null, "🔒 Менеджер паролей", -1)),
          _cache[3] || (_cache[3] = createBaseVNode("p", null, "Все ваши пароли надежно зашифрованы", -1)),
          error.value ? (openBlock(), createElementBlock("div", _hoisted_2, toDisplayString(error.value), 1)) : createCommentVNode("", true)
        ]),
        createBaseVNode("main", null, [
          editingEntry.value ? (openBlock(), createBlock(_sfc_main$1, {
            key: 0,
            "initial-data": editingEntry.value,
            onSubmit: handleAddPassword
          }, null, 8, ["initial-data"])) : (openBlock(), createElementBlock("button", {
            key: 1,
            class: "add-btn",
            onClick: _cache[0] || (_cache[0] = ($event) => editingEntry.value = { service: "", login: "", password: "" })
          }, " ➕ Добавить запись ")),
          passwords.value.length > 0 ? (openBlock(), createBlock(_sfc_main$2, {
            key: 2,
            passwords: passwords.value,
            "master-key": masterKey.value,
            onDelete: handleDelete,
            onEdit: handleEdit
          }, null, 8, ["passwords", "master-key"])) : !loading.value ? (openBlock(), createElementBlock("div", _hoisted_3, [..._cache[4] || (_cache[4] = [
            createBaseVNode("h2", null, "Нет сохраненных паролей", -1),
            createBaseVNode("p", null, 'Нажмите "Добавить запись", чтобы создать первую запись', -1)
          ])])) : createCommentVNode("", true)
        ]),
        createBaseVNode("footer", null, [
          createBaseVNode("button", {
            onClick: _cache[1] || (_cache[1] = ($event) => masterKey.value = null)
          }, "Сменить мастер-ключ")
        ]),
        !masterKey.value && !loading.value ? (openBlock(), createBlock(_sfc_main$3, {
          key: 0,
          onUnlock: handleUnlock
        })) : createCommentVNode("", true),
        loading.value ? (openBlock(), createElementBlock("div", _hoisted_4, "Загрузка...")) : createCommentVNode("", true)
      ]);
    };
  }
};
